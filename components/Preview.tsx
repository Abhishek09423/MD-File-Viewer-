...
const Preview: React.FC<PreviewProps> = ({ markdown }) => {
  return (
    <div className="h-full w-full bg-[#30302e] flex flex-col relative">
       {/* Removed the floating label to match Artifact UI cleaner look */}
      <div className="flex-1 w-full h-full overflow-y-auto px-6 py-8 sm:px-10 scroll-smooth">
        {/* Added id="printable-content" for print targeting */}
