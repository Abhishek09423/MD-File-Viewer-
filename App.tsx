...
const App: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-custom-dark text-slate-200">
      <Header 
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        {isSidebarOpen && (
            <aside className="w-64 bg-[#2a2a28] border-r border-white/5 flex-shrink-0 hidden md:block transition-all duration-300">
        ...
        <main className="flex-1 flex flex-col md:flex-row min-w-0">
          {/* Editor Pane (Hidden by default, toggled via Header) */}
          {isEditorVisible && (
          ...
          <div className={`h-full bg-custom-dark print-full-width min-w-0 ${isEditorVisible ? 'md:w-1/2' : 'w-full'}`}>
